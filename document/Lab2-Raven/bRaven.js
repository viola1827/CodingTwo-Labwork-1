...
class bRaven1 extends bRaven{
    ...
    checkPos(){
      ...
      let a = createVector(darkCrowDest[n][0] - this.position.x , darkCrowDest[n][1] - this.position.y);
      this.velocity = a.copy();
      this.velocity.setMag(4);
      this.dest.x = darkCrowDest[n][0];
      this.dest.y = darkCrowDest[n][1];
